...
class MadV9HO(IStrategy):
    ...
    buy_params = {
        ...
        "buy_bb20_close_bblowerband_safe_2": 0.983,
        "buy_volume_drop_1": 8.2,
        ...
        "buy_rsi_2": 24.2,
        "buy_rsi_3": 8.5,
        "buy_condition_10_rsi_reduce": 43.693,
        "buy_macd_1": 0.09,
        "buy_macd_2": 0.03,
    }
    ...
    buy_condition_012345_enable_optimize=False
    buy_condition_678910_enable_optimize=False
    buy_condition_0_enable = CategoricalParameter([True, False], default=True, space='buy', optimize=buy_condition_012345_enable_optimize, load=True)
    buy_condition_1_enable = CategoricalParameter([True, False], default=True, space='buy', optimize=buy_condition_012345_enable_optimize, load=True)
    buy_condition_2_enable = CategoricalParameter([True, False], default=True, space='buy', optimize=buy_condition_012345_enable_optimize, load=True)
    buy_condition_3_enable = CategoricalParameter([True, False], default=True, space='buy', optimize=buy_condition_012345_enable_optimize, load=True)
    buy_condition_4_enable = CategoricalParameter([True, False], default=True, space='buy', optimize=buy_condition_012345_enable_optimize, load=True)
    buy_condition_5_enable = CategoricalParameter([True, False], default=True, space='buy', optimize=buy_condition_012345_enable_optimize, load=True)
    buy_condition_6_enable = CategoricalParameter([True, False], default=True, space='buy', optimize=buy_condition_678910_enable_optimize, load=True)
    buy_condition_7_enable = CategoricalParameter([True, False], default=True, space='buy', optimize=buy_condition_678910_enable_optimize, load=True)
    buy_condition_8_enable = CategoricalParameter([True, False], default=True, space='buy', optimize=buy_condition_678910_enable_optimize, load=True)
    buy_condition_9_enable = CategoricalParameter([True, False], default=True, space='buy', optimize=buy_condition_678910_enable_optimize, load=True)
    buy_condition_10_enable = CategoricalParameter([True, False], default=True, space='buy', optimize=buy_condition_678910_enable_optimize, load=True)

    buy_bb20_close_bblowerband_safe_optimize = False
    buy_bb20_close_bblowerband_safe_1 = DecimalParameter(0.7, 1.1, default=0.99, space='buy', optimize=buy_bb20_close_bblowerband_safe_optimize, load=True)
    buy_bb20_close_bblowerband_safe_2 = DecimalParameter(0.7, 1.1, default=0.982, space='buy', optimize=buy_bb20_close_bblowerband_safe_optimize, load=True)

    buy_volume_optimize = True
    buy_volume_pump_1 = DecimalParameter(0.1, 0.9, default=0.4, space='buy', decimals=1, optimize=buy_volume_optimize, load=True)
    buy_volume_drop_1 = DecimalParameter(1, 10, default=4, space='buy', decimals=1, optimize=buy_volume_optimize, load=True)

    buy_rsi_1h_1_optimize = False
    buy_rsi_1h_2_optimize = False
    buy_rsi_1h_1 = DecimalParameter(10.0, 40.0, default=16.5, space='buy', decimals=1, optimize=buy_rsi_1h_1_optimize, load=True)
    buy_rsi_1h_2 = DecimalParameter(10.0, 40.0, default=15.0, space='buy', decimals=1, optimize=buy_rsi_1h_1_optimize, load=True)
    buy_rsi_1h_3 = DecimalParameter(10.0, 40.0, default=20.0, space='buy', decimals=1, optimize=buy_rsi_1h_2_optimize, load=True)
    buy_rsi_1h_4 = DecimalParameter(10.0, 40.0, default=35.0, space='buy', decimals=1, optimize=buy_rsi_1h_2_optimize, load=True)
    ...
    buy_condition_10_rsi_reduce = DecimalParameter(40, 45, default=43.276, space='buy', decimals=3, optimize=False, load=True)
    ...
    def populate_buy_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            ...
            (
                ...
                (dataframe['rsi'] < dataframe['rsi_1h'] - self.buy_condition_10_rsi_reduce.value) &
                (dataframe['volume'] > 0)
            ),
            'buy'
        ] = 1
