...
class sarhmav1(IStrategy):
    ...
    def informative_1h_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        stoch_rfast = ta.STOCHRSI(informative_1h, timeperiod=14)
        informative_1h['rfastd'] = stoch_rfast['fastd']
        informative_1h['rfastk'] = stoch_rfast['fastk']
        informative_1h['angle'] = ta.LINEARREG_ANGLE(informative_1h['close'], timeperiod=21)
