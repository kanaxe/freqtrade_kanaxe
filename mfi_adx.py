...
class mfiadx(IStrategy):
    ...
    trailing_stop_positive_offset = 0.01056
    ...
    def populate_buy_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                # (dataframe['hma19'] > dataframe['open'].shift(1))&
                # (dataframe['hma19'] < dataframe['close'].shift(1))&
                # (dataframe['hma19'] < dataframe['open'])
                ((dataframe['mfi'] - dataframe['adx']) > 13)&
                (qtpylib.crossed_above(dataframe['upsignal'], dataframe['hma19']))
            ),
            'buy'] = 1
    ...
    def populate_sell_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                (qtpylib.crossed_above(dataframe['mfi'], dataframe['adx']))
             ),
            'sell'] =1
        return dataframe
